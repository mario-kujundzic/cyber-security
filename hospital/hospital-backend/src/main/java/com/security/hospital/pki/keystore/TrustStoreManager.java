...
public class TrustStoreManager {
	...
	@Autowired
	public TrustStoreManager(@Value("${server.ssl.trust-store-password}") String keyStorePassword,
			@Value("${server.ssl.trust-store}") String keyStorePath) {
		try {
	...
	public void writeKey(String alias, PrivateKey privateKey, Certificate[] certificateChain) {
		try {
	...
	public void writeCert(String alias, Certificate certificate) {
		try {
